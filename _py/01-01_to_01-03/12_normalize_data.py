...
def run():
    ...
    # define a date range
    #dates = pd.date_range('1930-01-01', '2017-06-28')
    dates = pd.date_range('2017-05-02', '2017-06-28')
    #print(dates)

    # choose stock symbols to read
    #symbols = ['GOOG', 'IBM', 'GLD', 'APPL'] # SPY will be added in get_data()
    symbols = ['PETR3', 'PETR3.SA', 'PETR4.SA', 'CMIG4.SA', '^BVSP', 'CSNA3.SA', 'GOOG', 'IBM', 'GLD', 'APPL']  # SPY will be added in get_data()
    ...
    symbols_filtered = ['PETR3.SA', 'PETR4.SA', 'CMIG4.SA', 'CSNA3.SA']
    plot_selected(df, symbols_filtered, '2017-06-12', '2017-06-16')
